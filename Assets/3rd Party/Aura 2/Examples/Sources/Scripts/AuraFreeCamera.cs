...
namespace Aura2API //Original from Unity, changed namespace to avoid conflicts when importing official packages
{
    public class AuraFreeCamera : MonoBehaviour // Renamed from FreeCamera because it generated conflicts even though it was encapsulated in the AuraAPI namespace
    {
